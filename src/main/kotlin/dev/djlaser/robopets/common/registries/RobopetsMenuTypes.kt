...
object RobopetsMenuTypes {
  val MENU_TYPES: DeferredRegister<MenuType<*>> = DeferredRegister.create(Registries.MENU, RobopetsMod.MODID)

  val PET_TRANSCEIVER: Supplier<MenuType<PetTransceiverMenu>> = MENU_TYPES.register(
    "pet_transceiver",
    Supplier {
      IMenuTypeExtension.create { containerId, playerInv, buf ->
        PetTransceiverMenu.fromBuf(
          containerId,
          playerInv,
          buf
        )
